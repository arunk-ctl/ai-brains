...
parameters = TextGenerationParameters(
    decoding_method=DecodingMethod.SAMPLE, max_new_tokens=200, min_new_tokens=30, temperature=0.7, top_k=50, top_p=1)
...
def watsonx_response(prompt):
    response = client.text.chat.create(
        ...
        messages=[
            SystemMessage(
                content="""You are a helpful, respectful and honest chat assistant working for a Telecommunication company.
